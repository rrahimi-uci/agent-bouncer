...
def build_guards(args) -> list[tuple[str, object, int]]:
    ...
    if not args.no_openai and os.environ.get("OPENAI_API_KEY"):
        ...
        # Extra frontier baselines (e.g. gpt-5.4-mini) — one judge each, default reasoning budget.
...
def main() -> None:
    ...
    ap.add_argument("--baseline-models", nargs="*", default=["gpt-5.4-mini"],
                    help="extra frontier chat/judge baselines to score (default: gpt-5.4-mini)")
